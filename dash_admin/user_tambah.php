  ...
  <div class='content-wrapper'>
    ...
    <section class='content'>
      ...
      <div class='form-group'>
        ...
        <div class='col-sm-4'>
          <input type='email' class='form-control' name='n' placeholder='Contoh: syaiful@smkn1gunungsindur.sch.id'>
        </div>
        ...
        <div class='col-sm-4'>
          <div class="box box-solid box-primary">
            <div class="box-header">
              <h3 class="panel-title"><i class="fa fa-camera"></i> Canon D1300</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
      ...
      <div class="col-md-4">
        <div class="box box-solid box-danger">
            <div class="box-header">
              <h3 class="panel-title"><i class="fa fa-camera"></i> Hasil Canon D1300</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
