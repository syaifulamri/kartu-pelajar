<div class="wrapper"> <header class="main-header">
  ...
  <a href="home" class="logo">
    ...
    <span class="logo-lg" style="margin-left: -15px;"><b><img src="../assets/img/logo/<?php echo "$i[gambar] "; ?>" width="30px"> KARPEL V.01</b></span>
  </a>
...
<aside class="main-sidebar">
  ...
  <ul class="sidebar-menu">
    <li class="header bg-orange"><i class="fa fa-home"></i> MENU</li>
    <li class="treeview">
      <a href="home">
  ...
  <li class="treeview">
    <a href="view-datacsv">
      <i class="fa fa-indent"></i> <span>UPLOAD DATA</span>
    </a>
  </li>
  <li class="treeview">
    <a href="tag-data">
  ...
  <li class="treeview">
    <a href="upload-data">
      <i class="fa fa-cloud-upload"></i> <span>UPLOAD DATA</span>
    </a>
  </li>
  <li class="treeview">
    <a target='_Blank' href="download/data.php">
      <i class="fa fa-cloud-download"></i> <span>DOWNLOAD DATA</span>
    </a>
  </li>
  <li class="treeview">
    <a >
      <i class="glyphicon glyphicon-credit-card"></i> <span>DESAIN</span>
      <span class="pull-right-container">
        <i class="fa fa-angle-left pull-right"></i>
      </span>
    </a>
    <ul class="treeview-menu">
      <li><a href="update-blangko"><i class="fa fa-circle-o text-aqua"></i> BLANGKO</a></li>
  ...
  <li class="treeview">
    ...
    <ul class="treeview-menu">
      ...
      <li><a href="view-user"><i class="fa fa-circle-o text-aqua"></i> PENGGUNA</a></li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <center><img src="../assets/img/ups.png" width="30%">
          <h2>MENU INI HANYA DAPAT DIAKSES OLEH ADMINISTRATOR <br> <span class="text-purple">POWERED SMKN 1 Gunungsindur</span><br></h2>
        </center>
      </div>
      ...
      <div class="modal-body">
        <center><img src="../assets/img/logo/<?php echo "$i[gambar] "; ?>" width="90px">
          <!-- <marquee direction="up" height="100" onmouseout="this.start()" onmouseover="this.stop()" scrollamount="2"> -->
            <h2><strong><?php echo "$i[nama] "; ?></strong><br> <span class="text-purple">SMKN 1 Gunungsindur</span><br></h2>
            <label>Aplikasi ini dibuat untuk memudahkan pengisian data Siswa/i, dan sebaliknya keluaran dari aplikasi ini akan menghasilkan ID Card / Kartu Pelajar yang dapat langsung dicetak. <br>
              Selanjutnya  Aplikasi ini akang terus dikembangkan sesuai dengan kebutuhan sistem di SMKN 1 Gunungsindur. Terimakasih...
            </center>
          </label>
        </div>
        <div class="modal-footer">
