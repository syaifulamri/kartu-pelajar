...
error_reporting(1);
    ...
    if ($_FILES['gambar']['size'] != 0)
    {
     ...
     {  
    mysqli_query($koneksi, "INSERT INTO user (gambar, id_level, username, password, nama, jurusan, jk, tmp_lhr, tgl_lhr, alamat, id_prov, id_kab, id_kec, id_kel, hp, email, tgl_input, waktu, qrcode) VALUES ('$fileNama', '$_POST[b]', '$_POST[c]', '$pass', '$_POST[d]', '$_POST[ju], '$_POST[e]', '$_POST[f]', '$_POST[g]', '$_POST[h]', '$_POST[i]', '$_POST[j]', '$_POST[k]', '$_POST[l]', '$_POST[m]', '$_POST[n]', '$tgl', '$time', '$nameqrcode')");
        echo "<script>window.alert('Data Berhasil di Input!');
                window.location='../view-user'</script>";
    }
?>
