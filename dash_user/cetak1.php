...
<body onload='window.print()' style="font-family: arial;font-size: 13px;">
        <?php 
        ...
        ?>
            ...
            <img style="border-radius: 6px;border: 1px solid #222; position: absolute;margin-left: 30px;margin-top: 120px; width: 90px; height: 100px;overflow: hidden;" class="img-responsive img" src="../assets/img/user/<?php echo $r["gambar"];?>">
            ...
            <p style="letter-spacing: 2px;margin-left: 190px;padding-top: 110px;width: 240px; text-align: left; font-size: 17px"><b>KARTU PELAJAR</b></p>
