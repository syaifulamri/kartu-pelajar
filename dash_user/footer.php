...
<footer class="main-footer">
  <div class="container">
    ...
    <strong><?php $i = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM identitas LIMIT 1"));  echo "$i[nama] "; ?> <i class="fa fa-copyright"></i> Copyright <?php echo date("Y");?>. Powered by <a target="_blank" href="https://www.man1lampungtimur.sch.id"><b>SMKN 1 GUNUNGSINDUR</b></strong>
  </div>
  <!-- /.container -->
</footer>
